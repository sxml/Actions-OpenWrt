# 2025-11-05-FOL-2305
# 2025-11-05-diy-part2
# 字典-20251105 -FOL.tsv
# arm64-r25.10.27-huge.config
#
CONFIG_MODULES=y
...
# CONFIG_DEFAULT_luci-app-accesscontrol is not set#访问时间
CONFIG_DEFAULT_luci-app-arpbind=y
CONFIG_DEFAULT_luci-app-autoreboot=y
# CONFIG_DEFAULT_luci-app-ddns is not set#动态域名
CONFIG_DEFAULT_luci-app-filetransfer=y
CONFIG_DEFAULT_luci-app-nlbwmon=y
# CONFIG_DEFAULT_luci-app-ssr-plus is not set#ssr-plus
CONFIG_DEFAULT_luci-app-turboacc=y
CONFIG_DEFAULT_luci-app-upnp=y
# CONFIG_DEFAULT_luci-app-vlmcsd is not set#KMS服务器
# CONFIG_DEFAULT_luci-app-vsftpd is not set#FTP服务器
# CONFIG_DEFAULT_luci-app-wol is not set#WOL网络唤醒
...
# CONFIG_PACKAGE_sqm-scripts is not set #流量管理QOS
...
# CONFIG_PACKAGE_iwlwifi-firmware-ax200 is not set#Wifi基础包
# CONFIG_PACKAGE_iwlwifi-firmware-ax201 is not set#Wifi基础包
# CONFIG_PACKAGE_iwlwifi-firmware-ax210 is not set#Wifi基础包
...
# CONFIG_PACKAGE_iwlwifi-firmware-iwl3160 is not set#Wifi基础包
# CONFIG_PACKAGE_iwlwifi-firmware-iwl3168 is not set#Wifi基础包
...
# CONFIG_PACKAGE_iwlwifi-firmware-iwl7260 is not set#Wifi基础包
# CONFIG_PACKAGE_iwlwifi-firmware-iwl7265 is not set#Wifi基础包
# CONFIG_PACKAGE_iwlwifi-firmware-iwl7265d is not set#Wifi基础包
# CONFIG_PACKAGE_iwlwifi-firmware-iwl8260c is not set#Wifi基础包
# CONFIG_PACKAGE_iwlwifi-firmware-iwl8265 is not set#Wifi基础包
# CONFIG_PACKAGE_iwlwifi-firmware-iwl9000 is not set#Wifi基础包
# CONFIG_PACKAGE_iwlwifi-firmware-iwl9260 is not set#Wifi基础包
...
CONFIG_PACKAGE_kmod-lib-lz4-decompress=y
...
# Multiplexer Support
#
CONFIG_PACKAGE_kmod-mux-core=y
# CONFIG_PACKAGE_kmod-mux-gpio is not set
...
# CONFIG_PACKAGE_kmod-dwmac-imx is not set
...
# CONFIG_PACKAGE_kmod-fsl-dpaa2-net is not set
CONFIG_PACKAGE_kmod-fsl-enetc-net=y
# CONFIG_PACKAGE_kmod-fsl-fec is not set
...
# CONFIG_PACKAGE_kmod-mvpp2 is not set
...
# CONFIG_PACKAGE_kmod-thunderx-net is not set
...
# CONFIG_PACKAGE_kmod-bluetooth is not set#kmod-bluetooth蓝牙
...
# CONFIG_PACKAGE_kmod-usb-printer is not set#USB 打印服务器
...
# CONFIG_PACKAGE_kmod-ath is not set#Wifi基础包
# CONFIG_ATH_USER_REGD is not set#Wifi基础包
# CONFIG_PACKAGE_ATH_DEBUG is not set
# CONFIG_PACKAGE_ATH_DFS is not set#Wifi基础包
# CONFIG_PACKAGE_ATH_DYNACK is not set
# CONFIG_PACKAGE_kmod-ath10k is not set#Wifi基础包
# CONFIG_ATH10K_LEDS is not set#Wifi基础包
# CONFIG_ATH10K_THERMAL is not set#Wifi基础包
# CONFIG_PACKAGE_kmod-ath10k-ct is not set
# CONFIG_PACKAGE_kmod-ath10k-ct-smallbuffers is not set
# CONFIG_PACKAGE_kmod-ath10k-pci is not set#Wifi基础包
...
# CONFIG_PACKAGE_kmod-ath9k is not set#Wifi基础包
# CONFIG_ATH9K_HWRNG is not set
# CONFIG_ATH9K_SUPPORT_PCOEM is not set
# CONFIG_ATH9K_TX99 is not set
# CONFIG_PACKAGE_kmod-ath9k-common is not set#Wifi基础包
# CONFIG_PACKAGE_kmod-ath9k-htc is not set
# CONFIG_PACKAGE_kmod-b43 is not set
# CONFIG_PACKAGE_kmod-brcmfmac is not set#Wifi基础包
# CONFIG_BRCMFMAC_SDIO is not set#Wifi基础包
# CONFIG_BRCMFMAC_USB is not set
# CONFIG_BRCMFMAC_PCIE is not set
# CONFIG_PACKAGE_kmod-brcmsmac is not set
# CONFIG_PACKAGE_kmod-brcmutil is not set#Wifi基础包
# CONFIG_PACKAGE_BRCM80211_DEBUG is not set
# CONFIG_PACKAGE_kmod-carl9170 is not set#Wifi基础包
# CONFIG_PACKAGE_kmod-cfg80211 is not set#Wifi基础包
# CONFIG_PACKAGE_CFG80211_TESTMODE is not set
# CONFIG_PACKAGE_kmod-iwlwifi is not set#Wifi基础包
# CONFIG_PACKAGE_IWLWIFI_DEBUG is not set
# CONFIG_PACKAGE_kmod-mac80211 is not set#Wifi基础包
# CONFIG_PACKAGE_MAC80211_DEBUGFS is not set
# CONFIG_PACKAGE_MAC80211_TRACING is not set
# CONFIG_PACKAGE_MAC80211_MESH is not set#Wifi基础包
# CONFIG_PACKAGE_kmod-mac80211-hwsim is not set
# CONFIG_PACKAGE_kmod-mt76 is not set
# CONFIG_PACKAGE_kmod-mt76-connac is not set#Wifi基础包
# CONFIG_PACKAGE_kmod-mt76-core is not set#Wifi基础包
...
# CONFIG_PACKAGE_kmod-mt7921-common is not set#Wifi基础包
# CONFIG_PACKAGE_kmod-mt7921-firmware is not set#Wifi基础包
# CONFIG_PACKAGE_kmod-mt7921e is not set#Wifi基础包
...
# CONFIG_PACKAGE_kmod-mt792x-common is not set#Wifi基础包
...
# CONFIG_PACKAGE_kmod-rsi91x is not set#Wifi基础包
...
# Node.js
#
# CONFIG_PACKAGE_node is not set#node
...
# CONFIG_NODEJS_20 is not set#NODE
# CONFIG_NODEJS_22 is not set
# CONFIG_NODEJS_ICU_NONE is not set#NODEJS
...
# CONFIG_PACKAGE_node-npm is not set#NODE
...
CONFIG_PACKAGE_python3-bidict=y
# CONFIG_PACKAGE_python3-bidict-src is not set
...
CONFIG_PACKAGE_python3-engineio=y
# CONFIG_PACKAGE_python3-engineio-src is not set
...
CONFIG_PACKAGE_python3-itsdangerous=y
...
# CONFIG_WOLFSSL_HAS_OPENVPN is not set#openvpn
...
# CONFIG_PACKAGE_luci-lib-docker is not set#Docker容器
...
# CONFIG_PACKAGE_luci-app-acme is not set#ACME 证书
# CONFIG_PACKAGE_luci-app-adblock is not set
# CONFIG_PACKAGE_luci-app-adbyby-plus is not set
# CONFIG_PACKAGE_luci-app-adguardhome is not set#AD广告
# CONFIG_PACKAGE_luci-app-advanced-reboot is not set
# CONFIG_PACKAGE_luci-app-ahcp is not set
# CONFIG_PACKAGE_luci-app-airplay2 is not set#AirPlay音乐推流(安卓+IOS)
# CONFIG_PACKAGE_luci-app-alist is not set#Alist文件列表
...
# CONFIG_PACKAGE_luci-app-aria2 is not set#aria2下载
...
# CONFIG_PACKAGE_luci-app-ddns is not set#动态域名
...
# CONFIG_PACKAGE_luci-app-frpc is not set#内网穿透Frp客户端
# CONFIG_PACKAGE_luci-app-frps is not set#内网穿透Frp服务端
...
# CONFIG_PACKAGE_luci-app-ipsec-vpnd is not set#ipsec
...
# CONFIG_PACKAGE_luci-app-minidlna is not set#完全兼容DLNA
...
# CONFIG_PACKAGE_luci-app-mwan3 is not set#MWAN3负载均衡
# CONFIG_PACKAGE_luci-app-mwan3helper is not set#MWAN3分流助手
# CONFIG_PACKAGE_luci-app-n2n is not set#N2N内网穿透
...
# CONFIG_PACKAGE_luci-app-ocserv is not set#OpenConnect VPN服务
# CONFIG_PACKAGE_luci-app-oled is not set#oled
...
# CONFIG_PACKAGE_luci-app-openvpn is not set#openvpn
# CONFIG_PACKAGE_luci-app-openvpn-server is not set#OpenVPN服务器
...
# CONFIG_PACKAGE_luci-app-passwall_INCLUDE_V2ray_Plugin is not set#V2ray_Plugin
...
# CONFIG_PACKAGE_luci-app-passwall2_INCLUDE_V2ray_Plugin is not set#V2ray_Plugin
# end of Configuration
...
# CONFIG_PACKAGE_luci-app-pppwn is not set#pppwn
# CONFIG_PACKAGE_luci-app-pptp-server is not set#VPN服务器 PPTP
...
# CONFIG_PACKAGE_luci-app-qbittorrent is not set#BT下载工具
# CONFIG_PACKAGE_luci-app-qbittorrent_static is not set
# CONFIG_PACKAGE_luci-app-qbittorrent_dynamic is not set#BT下载工具
# CONFIG_PACKAGE_luci-app-qiyougamebooster is not set
# CONFIG_PACKAGE_luci-app-qos is not set
# CONFIG_PACKAGE_luci-app-radicale is not set
CONFIG_PACKAGE_luci-app-ramfree=y
# CONFIG_PACKAGE_luci-app-rclone is not set#云端同步工具
# CONFIG_PACKAGE_luci-app-rclone_INCLUDE_rclone-webui is not set#云端同步工具
# CONFIG_PACKAGE_luci-app-rclone_INCLUDE_rclone-ng is not set#云端同步工具
...
# CONFIG_PACKAGE_luci-app-softethervpn is not set#SoftEther VPN服务器 NAT穿透
# CONFIG_PACKAGE_luci-app-splash is not set
# CONFIG_PACKAGE_luci-app-sqm is not set##流量智能队列管理
# CONFIG_PACKAGE_luci-app-squid is not set
CONFIG_PACKAGE_luci-app-ssr-mudb-server=y
# CONFIG_PACKAGE_luci-app-ssr-plus is not set#ssr-plus
...
# CONFIG_PACKAGE_luci-app-ssr-plus_INCLUDE_Xray set#ssr-plus
# CONFIG_PACKAGE_luci-app-ssr-plus_INCLUDE_ChinaDNS_NG is not set#ssr-plus
# CONFIG_PACKAGE_luci-app-ssr-plus_INCLUDE_MosDNS is not set#ssr-plus
# CONFIG_PACKAGE_luci-app-ssr-plus_INCLUDE_Hysteria is not set#ssr-plus
# CONFIG_PACKAGE_luci-app-ssr-plus_INCLUDE_Tuic_Client is not set#ssr-plus
# CONFIG_PACKAGE_luci-app-ssr-plus_INCLUDE_Shadow_TLS is not set#ssr-plus
# CONFIG_PACKAGE_luci-app-ssr-plus_INCLUDE_IPT2Socks is not set#ssr-plus
# CONFIG_PACKAGE_luci-app-ssr-plus_INCLUDE_Kcptun is not set#ssr-plus
...
# CONFIG_PACKAGE_luci-app-unblockmusic_INCLUDE_UnblockNeteaseMusic_Go is not set#解锁网易云
...
# CONFIG_PACKAGE_luci-app-vlmcsd is not set#KMS服务器设置
...
# CONFIG_PACKAGE_luci-app-wol is not set#WOL网络唤醒
...
# 4. Themes
#
# CONFIG_PACKAGE_luci-theme-argon is not set#主题
# CONFIG_PACKAGE_luci-theme-argon-dark-mod is not set#主题
# CONFIG_PACKAGE_luci-theme-argon-light-mod is not set#主题
# CONFIG_PACKAGE_luci-theme-argon-mod is not set
# CONFIG_PACKAGE_luci-theme-atmaterial_new is not set#主题
CONFIG_PACKAGE_luci-theme-bootstrap=y
# CONFIG_PACKAGE_luci-theme-bootstrap-mod is not set#主题
CONFIG_PACKAGE_luci-theme-design=y
# CONFIG_PACKAGE_luci-theme-ifit is not set#主题
CONFIG_PACKAGE_luci-theme-material=y
# CONFIG_PACKAGE_luci-theme-mcat is not set#主题
# CONFIG_PACKAGE_luci-theme-netgear is not set
# CONFIG_PACKAGE_luci-theme-rosy is not set#主题
# CONFIG_PACKAGE_luci-theme-tomato is not set#主题
# end of 4. Themes
...
# CONFIG_PACKAGE_luci-i18n-accesscontrol-zh-cn is not set#访问时间控制
# CONFIG_PACKAGE_luci-i18n-acme-zh-cn is not set#ACME 证书
CONFIG_PACKAGE_luci-i18n-adguardhome-zh-cn=y
# CONFIG_PACKAGE_luci-i18n-airplay2-zh-cn is not set#AirPlay音乐推流(安卓+IOS)
# CONFIG_PACKAGE_luci-i18n-alist-zh-cn is not set#Alist文件列表
...
# CONFIG_PACKAGE_luci-i18n-aria2-zh-cn is not set#aria2下载
...
CONFIG_PACKAGE_luci-i18n-cpe-zh-cn=m
# CONFIG_PACKAGE_luci-i18n-cpe-zh_Hans is not set
...
# CONFIG_PACKAGE_luci-i18n-dockerman-zh-cn is not set#Docker容器
# CONFIG_PACKAGE_luci-i18n-dockerman-zh_Hans is not set
CONFIG_PACKAGE_luci-i18n-filebrowser-zh-cn=y
# CONFIG_PACKAGE_luci-i18n-filebrowser-zh_Hans is not set
...
# CONFIG_PACKAGE_luci-i18n-frpc-zh-cn is not set#内网穿透Frp客户端
# CONFIG_PACKAGE_luci-i18n-frps-zh-cn is not set#内网穿透Frp服务端
# CONFIG_PACKAGE_luci-i18n-haproxy-tcp-zh-cn is not set#HAProxy负载均衡
...
# CONFIG_PACKAGE_luci-i18n-hd-idle-en is not set#硬盘休眠
...
# CONFIG_PACKAGE_luci-i18n-hd-idle-zh-cn is not set#硬盘休眠
# CONFIG_PACKAGE_luci-i18n-hd-idle-zh-tw is not set
CONFIG_PACKAGE_luci-i18n-hypermodem-zh-cn=y
# CONFIG_PACKAGE_luci-i18n-ipsec-vpnd-zh-cn is not set#ipsec
...
# CONFIG_PACKAGE_luci-i18n-minidlna-en is not set#完全兼容DLNA
...
# CONFIG_PACKAGE_luci-i18n-minidlna-zh-cn is not set#完全兼容DLNA
...
# CONFIG_PACKAGE_luci-i18n-mjpg-streamer-zh-cn is not set#兼容Linux-UVC的摄像头
...
# CONFIG_PACKAGE_luci-i18n-mwan3-zh-cn is not set#MWAN3负载均衡
# CONFIG_PACKAGE_luci-i18n-mwan3-zh-tw is not set
# CONFIG_PACKAGE_luci-i18n-mwan3helper-zh-cn is not set#MWAN3分流助手
# CONFIG_PACKAGE_luci-i18n-n2n-zh-cn is not set#N2N内网穿透
CONFIG_PACKAGE_luci-i18n-netdata-zh-cn=y
# CONFIG_PACKAGE_luci-i18n-nlbwmon-ja is not set
# CONFIG_PACKAGE_luci-i18n-nlbwmon-ru is not set
CONFIG_PACKAGE_luci-i18n-nlbwmon-zh-cn=y
# CONFIG_PACKAGE_luci-i18n-oled-zh-cn is not set#oled
# CONFIG_PACKAGE_luci-i18n-oled-zh-tw is not set
...
# CONFIG_PACKAGE_luci-i18n-openvpn-en is not set#openvpn
...
# CONFIG_PACKAGE_luci-i18n-openvpn-server-zh-cn is not set#OpenVPN客户端
...
# CONFIG_PACKAGE_luci-i18n-openvpn-zh-cn is not set#openvpn
...
# CONFIG_PACKAGE_luci-i18n-pppwn-zh-cn is not set#pppwn
# CONFIG_PACKAGE_luci-i18n-pptp-server-zh-cn is not set#VPN服务器 PPTP
# CONFIG_PACKAGE_luci-i18n-qbittorrent-zh-cn is not set#BT下载工具
CONFIG_PACKAGE_luci-i18n-ramfree-zh-cn=y
# CONFIG_PACKAGE_luci-i18n-rclone-en is not set#云端同步工具
# CONFIG_PACKAGE_luci-i18n-rclone-zh-cn is not set#云端同步工具
...
# CONFIG_PACKAGE_luci-i18n-sms-tool-zh_Hans is not set
# CONFIG_PACKAGE_luci-i18n-softethervpn-zh-cn is not set#SoftEther VPN服务器
...
# CONFIG_PACKAGE_luci-i18n-sqm-en is not set#流量智能队列管理
...
# CONFIG_PACKAGE_luci-i18n-sqm-zh-cn is not set#流量智能队列管理（QOS
...
# CONFIG_PACKAGE_luci-i18n-ssr-plus-zh-cn is not set#ssr-plus
...
# CONFIG_PACKAGE_luci-i18n-transmission-en is not set#BT下载工具
...
# CONFIG_PACKAGE_luci-i18n-udpxy-zh-cn is not set#udpxy做组播服务器
...
# CONFIG_PACKAGE_luci-i18n-usb-printer-zh-cn is not set#USB 打印服务器
# CONFIG_PACKAGE_luci-i18n-uugamebooster-zh-cn is not set#UU游戏加速器
# CONFIG_PACKAGE_luci-i18n-verysync-zh-cn is not set#微力同步
# CONFIG_PACKAGE_luci-i18n-vlmcsd-zh-cn is not set#KMS服务器设置
# CONFIG_PACKAGE_luci-i18n-vsftpd-zh-cn is not set#FTP服务器
...
# CONFIG_PACKAGE_luci-i18n-wifischedule-zh-cn is not set#WiFi 计划
...
# CONFIG_PACKAGE_luci-i18n-wol-en is not set#WOL网络唤醒
...
# CONFIG_PACKAGE_luci-i18n-wol-zh-cn is not set#WOL网络唤醒
# CONFIG_PACKAGE_luci-i18n-wol-zh-tw is not set
# CONFIG_PACKAGE_luci-i18n-zerotier-zh-cn is not set#ZeroTier内网穿透
# end of LuCI
...
# CONFIG_PACKAGE_UnblockNeteaseMusic is not set#解除网易云
# CONFIG_PACKAGE_UnblockNeteaseMusicGo is not set#解除网易云
...
# CONFIG_PACKAGE_koolproxy is not set#去广告
# CONFIG_PACKAGE_lcdgrilo is not set
# CONFIG_PACKAGE_minidlna is not set#完全兼容DLNA
# CONFIG_PACKAGE_minisatip is not set
# CONFIG_PACKAGE_mjpg-streamer is not set#兼容Linux-UVC的摄像头程序
# CONFIG_MJPG_STREAMER_V4L2 is not set#摄像头
# CONFIG_PACKAGE_mjpg-streamer-input-file is not set#摄像头
# CONFIG_PACKAGE_mjpg-streamer-input-http is not set#摄像头
# CONFIG_PACKAGE_mjpg-streamer-input-uvc is not set#摄像头
# CONFIG_PACKAGE_mjpg-streamer-output-file is not set#摄像头
# CONFIG_PACKAGE_mjpg-streamer-output-http is not set#摄像头
# CONFIG_PACKAGE_mjpg-streamer-output-rtsp is not set#摄像头
# CONFIG_PACKAGE_mjpg-streamer-output-zmq is not set#摄像头
# CONFIG_PACKAGE_mjpg-streamer-www is not set#摄像头
...
# CONFIG_PACKAGE_qBittorrent is not set#BT下载工具
...
# CONFIG_PACKAGE_transmission-web-control is not set#BT下载工具
# end of BitTorrent
...
# Cloud Manager
#
# CONFIG_PACKAGE_rclone-ng is not set#云端同步工具
# CONFIG_PACKAGE_rclone-webui-react is not set#云端同步工具
...
# File Transfer
#
# CONFIG_PACKAGE_aria2 is not set#aria2下载

#
# Aria2 Configuration
#
# CONFIG_ARIA2_OPENSSL is not set#aria2下载
# CONFIG_ARIA2_GNUTLS is not set
# CONFIG_ARIA2_NOSSL is not set
# CONFIG_ARIA2_LIBXML2 is not set#aria2下载
# CONFIG_ARIA2_EXPAT is not set
# CONFIG_ARIA2_NOXML is not set
# CONFIG_ARIA2_BITTORRENT is not set#aria2下载
# CONFIG_ARIA2_METALINK is not set#aria2下载
# CONFIG_ARIA2_SFTP is not set#aria2下载
# CONFIG_ARIA2_ASYNC_DNS is not set#aria2下载
# CONFIG_ARIA2_COOKIE is not set#aria2下载
# CONFIG_ARIA2_WEBSOCKET is not set#aria2下载
...
# CONFIG_PACKAGE_rclone is not set#云端同步工具
# CONFIG_PACKAGE_rclone-config is not set #云端同步工具
...
# CONFIG_PACKAGE_vsftpd-alt is not set#FTP服务器
# CONFIG_VSFTPD_USE_UCI_SCRIPTS is not set#FTP服务器
...
# Printing
#
# CONFIG_PACKAGE_p910nd is not set#打印服务器模块
# end of Printing
...
# CONFIG_PACKAGE_mwan3 is not set#MWAN3负载均衡
...
# CONFIG_PACKAGE_n2n is not set #N2N内网穿透
# CONFIG_PACKAGE_n2n-utils is not set
# CONFIG_PACKAGE_ocserv is not set#OpenConnect VPN服务
...
# CONFIG_OCSERV_PROTOBUF is not set#OpenConnect VPN服务
# CONFIG_OCSERV_HTTP_PARSER is not set#OpenConnect VPN服务
# end of Configuration
...
# CONFIG_PACKAGE_openvpn-easy-rsa is not set#OpenVPN客户端
# CONFIG_PACKAGE_openvpn-mbedtls is not set
# CONFIG_PACKAGE_openvpn-openssl is not set#OpenVPN客户端
# CONFIG_OPENVPN_openssl_ENABLE_LZO is not set#OpenVPN客户端
# CONFIG_OPENVPN_openssl_ENABLE_LZ4 is not set#OpenVPN客户端
# CONFIG_OPENVPN_openssl_ENABLE_X509_ALT_USERNAME is not set
# CONFIG_OPENVPN_openssl_ENABLE_MANAGEMENT is not set
# CONFIG_OPENVPN_openssl_ENABLE_FRAGMENT is not set#OpenVPN客户端
# CONFIG_OPENVPN_openssl_ENABLE_MULTIHOME is not set#OpenVPN客户端
# CONFIG_OPENVPN_openssl_ENABLE_PORT_SHARE is not set#OpenVPN客户端
# CONFIG_OPENVPN_openssl_ENABLE_DEF_AUTH is not set#OpenVPN客户端
# CONFIG_OPENVPN_openssl_ENABLE_PF is not set#OpenVPN客户端
# CONFIG_OPENVPN_openssl_ENABLE_IPROUTE2 is not set
# CONFIG_OPENVPN_openssl_ENABLE_SMALL is not set#OpenVPN客户端
# CONFIG_PACKAGE_openvpn-wolfssl is not set
# CONFIG_PACKAGE_pgyvpn is not set
# CONFIG_PACKAGE_pptpd is not set#VPN服务器 PPTP
...
# CONFIG_PACKAGE_softethervpn5-bridge is not set#SoftEther VPN服务器 NAT穿透
# CONFIG_PACKAGE_softethervpn5-client is not set#SoftEther VPN服务器 NAT穿透
# CONFIG_PACKAGE_softethervpn5-libs is not set#SoftEther VPN服务器 NAT穿透
# CONFIG_PACKAGE_softethervpn5-server is not set#SoftEther VPN服务器 NAT穿透
...
# CONFIG_PACKAGE_zerotier is not set#ZeroTier内网穿透
...
# CONFIG_PACKAGE_alist is not set#Alist文件列表
...
# CONFIG_PACKAGE_frpc is not set#内网穿透Frp客户端
# CONFIG_PACKAGE_frps is not set#内网穿透Frp服务端
# CONFIG_PACKAGE_gateway-go is not set
CONFIG_PACKAGE_haproxy=y
# CONFIG_PACKAGE_halog is not set
# CONFIG_PACKAGE_haproxy-nossl is not set
# CONFIG_PACKAGE_kcptun-client is not set#Kcptun
# CONFIG_PACKAGE_kcptun-config is not set#Kcptun
...
# CONFIG_PACKAGE_v2ray-plugin is not set#v2ray-plugin
...
# CONFIG_PACKAGE_wifischedule is not set#WiFi 计划
# end of Wireless
...
# CONFIG_PACKAGE_hostapd-common is not set#Wifi基础包
...
# CONFIG_PACKAGE_wpa-cli is not set#Wifi基础包
# CONFIG_PACKAGE_wpa-supplicant is not set
# CONFIG_WPA_RFKILL_SUPPORT is not set
CONFIG_WPA_MSG_MIN_PRIORITY=3
# CONFIG_WPA_WOLFSSL is not set
# CONFIG_DRIVER_11AC_SUPPORT is not set#Wifi基础包
# CONFIG_DRIVER_11AX_SUPPORT is not set#Wifi基础包
# CONFIG_DRIVER_11BE_SUPPORT is not set
# CONFIG_WPA_ENABLE_WEP is not set
# CONFIG_WPA_MBO_SUPPORT is not set#Wifi基础包
...
# CONFIG_PACKAGE_wpad is not set#Wifi基础包
...
# CONFIG_PACKAGE_acme is not set#ACME 证书
...
# CONFIG_PACKAGE_adbyby is not set#广告
...
# CONFIG_PACKAGE_iw is not set#Wifi基础包
...
# CONFIG_PACKAGE_pppwn-cpp is not set#pppwn
...
# CONFIG_PACKAGE_socat is not set#多功能的网络工具
# CONFIG_SOCAT_SSL is not set#多功能的网络工具
...
# CONFIG_PACKAGE_udpxy is not set#udpxy做组播服务器
...
# CONFIG_PACKAGE_uugamebooster is not set#UU游戏加速器
# CONFIG_PACKAGE_v2ray-core is not set
# CONFIG_PACKAGE_vallumd is not set
# CONFIG_PACKAGE_verysync is not set#微力同步
# CONFIG_PACKAGE_vlmcsd is not set#KMS服务器设置
...
# CONFIG_PACKAGE_wol is not set#WOL网络唤醒
...
# CONFIG_PACKAGE_hd-idle is not set#硬盘休眠
...
# CONFIG_PACKAGE_acpid is not set#acpid
...
# CONFIG_PACKAGE_docker is not set#Docker容器
# CONFIG_PACKAGE_docker-compose is not set#Docker容器
# CONFIG_PACKAGE_dockerd is not set#Docker容器
# CONFIG_DOCKER_CHECK_CONFIG is not set
# CONFIG_DOCKER_CGROUP_OPTIONS is not set#Docker容器
# CONFIG_DOCKER_OPTIONAL_FEATURES is not set

#
# Network
#
# CONFIG_DOCKER_NET_OVERLAY is not set#Docker容器
# CONFIG_DOCKER_NET_ENCRYPT is not set
# CONFIG_DOCKER_NET_MACVLAN is not set#Docker容器
# CONFIG_DOCKER_NET_TFTP is not set#Docker容器
# end of Network
...
# CONFIG_DOCKER_STO_EXT4 is not set#Docker容器
# CONFIG_DOCKER_STO_BTRFS is not set#Docker容器
# end of Storage
...
# CONFIG_PACKAGE_iwinfo is not set#Wifi基础包
CONFIG_PACKAGE_jq=y
...
#CONFIG_OVERRIDE_PKGS="dns2socks libxcrypt luci-app-ocserv luci-app-pptp-server luci-app-serverchan luci-theme-argon luci-theme-design microsocks"
