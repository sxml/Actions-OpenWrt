...
## sfe.config
2174 # CONFIG_PACKAGE_kmod-ipt-offload is not set
2303    CONFIG_PACKAGE_kmod-fast-classifier=y
2366    CONFIG_PACKAGE_kmod-shortcut-fe=y
3090 # CONFIG_PACKAGE_kmod-nf-flow is not set
4611 # CONFIG_PACKAGE_luci-app-flowoffload is not set
