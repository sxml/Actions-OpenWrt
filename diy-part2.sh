...
# CONFIG_DEFAULT_luci-app-accesscontrol is not set
...
# CONFIG_PACKAGE_luci-app-bypass_INCLUDE_V2ray is not set
...
# CONFIG_PACKAGE_luci-i18n-amule-zh-cn is not set
...
# CONFIG_PACKAGE_luci-i18n-kodexplorer-zh-cn is not set
...
# CONFIG_PACKAGE_luci-i18n-mjpg-streamer-zh-cn is not set
# CONFIG_PACKAGE_luci-i18n-music-remote-center-zh-cn is not set
...
# CONFIG_PACKAGE_luci-i18n-n2n_v2-zh-cn is not set
...
# CONFIG_PACKAGE_luci-i18n-nps-zh-cn is not set
...
# CONFIG_PACKAGE_luci-i18n-verysync-zh-cn is not set
...
# CONFIG_OCSERV_PROTOBUF is not set
# CONFIG_OCSERV_HTTP_PARSER is not set
# end of Configuration
...
# CONFIG_OPENVPN_openssl_ENABLE_SERVER is not set
...
# CONFIG_PACKAGE_softethervpn5-libs is not set
