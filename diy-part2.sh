...
svn co https://github.com/liuran001/openwrt-packages/trunk/trojan-go package/trojan-go
...
#依IP地址限速
#n co https://github.com/kenzok8/openwrt-packages/trunk/luci-app-eqos package/luci-app-eqos
