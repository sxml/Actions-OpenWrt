...
#svn co https://github.com/xiaorouji/openwrt-passwall-packages/branches/luci/luci-app-passwall package/luci-app-passwall
svn co https://github.com/xiaorouji/openwrt-passwall-packages/branches/luci-smartdns-dev/luci-app-passwall package/luci-app-passwall
#svn co https://github.com/xiaorouji/openwrt-passwall-packages/branches/luci-smartdns-new-version/luci-app-passwall package/luci-app-passwall
#svn co https://github.com/xiaorouji/openwrt-passwall-packages2/trunk/luci-app-passwall2 package/luci-app-passwall2
